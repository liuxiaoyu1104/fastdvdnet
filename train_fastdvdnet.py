...
from datasets.DAVIS_seq import Val_set,Train_set
...
def main(**args):
	...
	dataset_val = Val_set(valsetdir=args['valset_dir'], gray_mode=False)
	dataset_train = Train_set(seq_dir=args['trainset_dir'], \
                              train_length=args['train_length'], \
                              patch_size=args['patch_size'], \
                              patches_per_epoch=args['max_number_patches'], \
                              image_postfix='npy')
	...
	ctrl_fr_idx = (args['train_length'] - 1) // 2
	...
	for epoch in range(start_epoch, args['epochs']):
		...
		for i, data in enumerate(loader_train, 0):
			...
			stdn = torch.empty((N, 1, 1, 1)).uniform_(args['noise_ival'][0], to=args['noise_ival'][1])
...
if __name__ == "__main__":
	...
	parser.add_argument("--val_noiseL", type=float, default=40, \
						help='noise level used on validation set')
	# Preprocessing parameters
	parser.add_argument("--patch_size", "--p", type=int, default=96, help="Patch size")
	parser.add_argument("--train_length", "--tp", type=int, default=5, help="Temporal patch size")
	parser.add_argument("--max_number_patches", "--m", type=int, default=384000, \
						help="Maximum number of patches")
	# Dirs
	parser.add_argument("--log_dir", type=str, default="log/logs_ben_scale_cv", \
					 help='path of log files')
	parser.add_argument("--trainset_dir", type=str, default='/home/mist/dataset/DAVIS/train/test', \
					 help='path of trainset')
	parser.add_argument("--valset_dir", type=str, default='/home/mist/dataset/DAVIS/test', \
